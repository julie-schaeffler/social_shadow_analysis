...
public class SaveActiveChildMeshesAsPrefab : EditorWindow
{
    GameObject targetObject;

    [MenuItem("Tools/Save Active Child Meshes as Prefab")]
    public static void ShowWindow()
    {
        GetWindow(typeof(SaveActiveChildMeshesAsPrefab), false, "Prefab Saver");
    }

    private void OnGUI()
    {
        GUILayout.Label("Speichere aktive Child Meshes als Prefab", EditorStyles.boldLabel);
